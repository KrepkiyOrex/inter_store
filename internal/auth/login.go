...
*******************************************************
	...
	Что осталось:
		добавление заказа
		extractToken - это куда вообще тут нужно?
		как проверить работают ли нужные функции?
		"my_secret_key" - ???
		в хендлеры надо чего подклбчить?
...
// для выполнения нужных действий в обработчике
